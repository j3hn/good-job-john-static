...
const chapters = {
  ...
  now: [
    ...
    "Bringing product thinking, interface design and agentic development together through Runway, Flair and Slate. An ongoing interest in physical making continues through 3D printing.",
  ],
};
